        ...
        botonGuardar.setOnClickListener{
            ...
            if (nombre.isNotEmpty() && tipo.isNotEmpty() && anio!=null) {
                if (cancionId == -1) {
                    ...
                    val respuesta = EBaseDatos.tablas!!.crearCancion(nombre,tipo,anio, artistaId)
                    ...
                    val respuesta = EBaseDatos.tablas!!.actualizarCancionFormulario(nombre,tipo,anio,artistaId,cancionId)
